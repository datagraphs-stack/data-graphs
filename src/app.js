...
let state={sourceBytes:null,rows:[],profile:null,result:null,name:'',dataGraph:null,revisions:[],pendingInterpretation:null};
...
function load(sourceBytes,name){
  try{
    ...
    state={sourceBytes:new Uint8Array(sourceBytes),rows,profile,result:null,name,dataGraph:null,revisions:[],pendingInterpretation:null};
    $('#run').disabled=false;
